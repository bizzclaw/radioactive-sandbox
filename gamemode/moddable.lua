...
GM.MaxLoot = 10            // Maximum amount of random loot to be generated at any time
...
function GM:LootThink()
	...
	local num = amt - total
	local tbl = { ITEM_FOOD, ITEM_FOOD, ITEM_FOOD, ITEM_FOOD, ITEM_FOOD, ITEM_SUPPLY, ITEM_SUPPLY, ITEM_SUPPLY, ITEM_SUPPLY, ITEM_LOOT, ITEM_LOOT, ITEM_LOOT, ITEM_AMMO, ITEM_AMMO, ITEM_MISC, ITEM_EXODUS, ITEM_WPN_COMMON }
	...
	if num > 0 then
		...
		for i=1, num do
			...
			for j=1, math.random(2,5) do
				...
				local rand = item.RandomItem( table.Random( tbl ) )
